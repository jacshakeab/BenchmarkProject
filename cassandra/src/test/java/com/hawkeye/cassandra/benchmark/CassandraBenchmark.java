package com.hawkeye.cassandra.benchmark;
...
import com.hawkeye.cassandra.repository.StudentRepository;
...
public class CassandraBenchmark extends AbstractMySQLBenchmark
{
    ...
    {
        CassandraBenchmark.studentRepository = studentRepository;
    }
