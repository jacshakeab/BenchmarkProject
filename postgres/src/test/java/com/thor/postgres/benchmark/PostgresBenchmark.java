package com.thor.postgres.benchmark;
...
import com.thor.postgres.repository.StudentRepository;
...
public class PostgresBenchmark extends AbstractMySQLBenchmark
{
    private static StudentRepository studentRepository;

    @Autowired
    private void setStudentRepository(StudentRepository studentRepository) {
        PostgresBenchmark.studentRepository = studentRepository;
    }
